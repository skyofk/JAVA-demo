...
import com.example.pets.adapter.CartAdapter;
import com.example.pets.datebase.ShoppingDBHelper;
import com.example.pets.entity.CartInfo;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_shopping_channel:
                // 从购物车页面跳到商场页面
                Intent intent = new Intent(this, com.example.pets.ShoppingChannelActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(ShoppingCartActivity.this, com.example.pets.ShoppingDetailActivity.class);
